...
module.exports = model('User', schema) // Экспортируем из модуля результат работы функции model. Первым параметром передаем название нашей модели, а вторым схему по которой она работает